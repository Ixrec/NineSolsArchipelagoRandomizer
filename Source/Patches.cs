...
public class Patches {
    ...
    static void LootSpawner_SpawnWithPercentage(LootSpawner __instance, float percentage, Vector3 dropPosition) {
        if (percentage < 1) {
            ...
            var goPath = LocationTriggers.GetFullPath(__instance.gameObject);
    ...
    public static void BossDieFlower_Start(BossDieFlower __instance) {
        Log.Info($"BossDieFlower_Start {LocationTriggers.GetFullPath(__instance.gameObject)}");
    }
    ...
    public static void BossDieFlower_ShowFlower(BossDieFlower __instance) {
        Log.Info($"BossDieFlower_ShowFlower {LocationTriggers.GetFullPath(__instance.gameObject)}");
    }
