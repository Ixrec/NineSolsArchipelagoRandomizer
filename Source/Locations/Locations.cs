...
public enum Location {
    ...
    SHOP_KUAFU_NORMAL_2,
    SHOP_KUAFU_EXTRA_1,
    SHOP_KUAFU_DARK_STEEL_1,
    SHOP_KUAFU_DARK_STEEL_2,
    SHOP_KUAFU_DARK_STEEL_3,
    SHOP_KUAFU_EXTRA_DARK_STEEL_1,
    SHOP_KUAFU_EXTRA_DARK_STEEL_2,
    SHOP_KUAFU_EXTRA_DARK_STEEL_3,
    SHOP_KUAFU_HERB_CATALYST_1,
    SHOP_KUAFU_HERB_CATALYST_2,
    SHOP_KUAFU_HERB_CATALYST_3,
    SHOP_KUAFU_HERB_CATALYST_4,
    SHOP_KUAFU_HERB_CATALYST_5,
    SHOP_KUAFU_HERB_CATALYST_6,
    SHOP_KUAFU_HERB_CATALYST_7,
    SHOP_KUAFU_HERB_CATALYST_8,
    SHOP_KUAFU_NORMAL_3,
    SHOP_KUAFU_NORMAL_4,
    SHOP_KUAFU_EXTRA_2,
    ...
    SHOP_CHIYOU_LOW_4,
    SHOP_CHIYOU_LOW_5,
    SHOP_CHIYOU_MEDIUM_1,
    SHOP_CHIYOU_MEDIUM_2,
    SHOP_CHIYOU_MEDIUM_3,
    SHOP_CHIYOU_MEDIUM_4,
    SHOP_CHIYOU_MEDIUM_5,
    SHOP_CHIYOU_MEDIUM_6,
    SHOP_CHIYOU_HIGH_1,
    SHOP_CHIYOU_HIGH_2,
    SHOP_CHIYOU_HIGH_3,
    SHOP_CHIYOU_HIGH_4,
...
internal class LocationNames {
    public static Dictionary<Location, string> locationNames = new Dictionary<Location, string> {
        ...
        { Location.SHOP_KUAFU_NORMAL_1, "Kuafu's Shop: 1st Normal Purchase" },
        { Location.SHOP_KUAFU_NORMAL_2, "Kuafu's Shop: 2nd Normal Purchase" },
        { Location.SHOP_KUAFU_EXTRA_1, "Kuafu's Extra Inventory: 1st Normal Purchase" },
        { Location.SHOP_KUAFU_DARK_STEEL_1, "Kuafu's Shop: 1st Dark Steel Purchase" },
        { Location.SHOP_KUAFU_DARK_STEEL_2, "Kuafu's Shop: 2nd Dark Steel Purchase" },
        { Location.SHOP_KUAFU_DARK_STEEL_3, "Kuafu's Shop: 3rd Dark Steel Purchase" },
        { Location.SHOP_KUAFU_EXTRA_DARK_STEEL_1, "Kuafu's Extra Inventory: 1st Dark Steel Purchase" },
        { Location.SHOP_KUAFU_EXTRA_DARK_STEEL_2, "Kuafu's Extra Inventory: 2nd Dark Steel Purchase" },
        { Location.SHOP_KUAFU_EXTRA_DARK_STEEL_3, "Kuafu's Extra Inventory: 3rd Dark Steel Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_1, "Kuafu's Shop: 1st Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_2, "Kuafu's Shop: 2nd Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_3, "Kuafu's Shop: 3rd Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_4, "Kuafu's Shop: 4th Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_5, "Kuafu's Shop: 5th Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_6, "Kuafu's Shop: 6th Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_7, "Kuafu's Shop: 7th Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_HERB_CATALYST_8, "Kuafu's Shop: 8th Herb Catalyst Purchase" },
        { Location.SHOP_KUAFU_NORMAL_3, "Kuafu's Shop: 3rd Normal Purchase" },
        { Location.SHOP_KUAFU_NORMAL_4, "Kuafu's Shop: 4th Normal Purchase" },
        { Location.SHOP_KUAFU_EXTRA_2, "Kuafu's Extra Inventory: 2nd Normal Purchase" },

        { Location.SHOP_CHIYOU_LOW_1, "Chiyou's Shop: 1st Low Cost Purchase" },
        { Location.SHOP_CHIYOU_LOW_2, "Chiyou's Shop: 2nd Low Cost Purchase" },
        { Location.SHOP_CHIYOU_LOW_3, "Chiyou's Shop: 3rd Low Cost Purchase" },
        { Location.SHOP_CHIYOU_LOW_4, "Chiyou's Shop: 4th Low Cost Purchase" },
        { Location.SHOP_CHIYOU_LOW_5, "Chiyou's Shop: 5th Low Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_1, "Chiyou's Shop: 1st Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_2, "Chiyou's Shop: 2nd Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_3, "Chiyou's Shop: 3rd Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_4, "Chiyou's Shop: 4th Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_5, "Chiyou's Shop: 5th Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_MEDIUM_6, "Chiyou's Shop: 6th Medium Cost Purchase" },
        { Location.SHOP_CHIYOU_HIGH_1, "Chiyou's Shop: 1st High Cost Purchase" },
        { Location.SHOP_CHIYOU_HIGH_2, "Chiyou's Shop: 2nd High Cost Purchase" },
        { Location.SHOP_CHIYOU_HIGH_3, "Chiyou's Shop: 3rd High Cost Purchase" },
        { Location.SHOP_CHIYOU_HIGH_4, "Chiyou's Shop: 4th High Cost Purchase" },
        { Location.SHOP_CHIYOU_HIGH_5, "Chiyou's Shop: 5th High Cost Purchase" },

        { Location.SHOP_PRINTER_LOW_1, "3D Printer: 1st Low Cost Purchase" },
        { Location.SHOP_PRINTER_LOW_2, "3D Printer: 2nd Low Cost Purchase" },
        { Location.SHOP_PRINTER_LOW_3, "3D Printer: 3rd Low Cost Purchase" },
        { Location.SHOP_PRINTER_LOW_4, "3D Printer: 4th Low Cost Purchase" },
        { Location.SHOP_PRINTER_MEDIUM_1, "3D Printer: 1st Medium Cost Purchase" },
        { Location.SHOP_PRINTER_HIGH_1, "3D Printer: 1st High Cost Purchase" },
        { Location.SHOP_PRINTER_HIGH_2, "3D Printer: 2nd High Cost Purchase" },

        { Location.SKILL_SWIFT_RUNNER, "Skill Tree Node: Swift Runner" },
        { Location.SKILL_QB_TL, "Skill Tree Node: Qi Boost (Top Left)" },
        { Location.SKILL_SS, "Skill Tree Node: Shadow Strike" },
        { Location.SKILL_BD, "Skill Tree Node: Bullet Deflect" },
        { Location.SKILL_SWIFT_RISE, "Skill Tree Node: Swift Rise" },
        { Location.SKILL_LR, "Skill Tree Node: Life Recovery" },
        { Location.SKILL_QB_TR, "Skill Tree Node: Qi Boost (Top Right)" },
        { Location.SKILL_BL, "Skill Tree Node: Backlash" },
        { Location.SKILL_SK, "Skill Tree Node: Skull Kick" },
        { Location.SKILL_BE, "Skill Tree Node: Breathing Exercise" },
        { Location.SKILL_LV, "Skill Tree Node: Leverage" },
        { Location.SKILL_WF, "Skill Tree Node: Water Flow" },
        { Location.SKILL_FC, "Skill Tree Node: Full Control" },
        { Location.SKILL_ID, "Skill Tree Node: Incisive Drain" },
        { Location.SKILL_EBD, "Skill Tree Node: Enhanced Bullet Deflect" },
        { Location.SKILL_EB_L, "Skill Tree Node: Enhanced Blade (Left)" },
        { Location.SKILL_UD, "Skill Tree Node: Unbounded Drain" },
        { Location.SKILL_ET_L, "Skill Tree Node: Enhanced Talisman (Left)" },
        { Location.SKILL_QB_BL, "Skill Tree Node: Qi Boost (Bottom Left)" },
        { Location.SKILL_AR, "Skill Tree Node: Azure Recovery" },
        { Location.SKILL_QB_BR, "Skill Tree Node: Qi Boost (Bottom Right)" },
        { Location.SKILL_ET_R, "Skill Tree Node: Enhanced Talisman (Right)" },
        { Location.SKILL_EB_R, "Skill Tree Node: Enhanced Blade (Right)" },
        { Location.SKILL_UC, "Skill Tree Node: Unbounded Charge" },
        { Location.SKILL_EWF, "Skill Tree Node: Enhanced Water Flow" },
        { Location.SKILL_EFC, "Skill Tree Node: Enhanced Full Control" },
        { Location.SKILL_EQB, "Skill Tree Node: Enhanced Qi Blast" },
    };
