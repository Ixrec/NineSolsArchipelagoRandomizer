...
public enum Location {
    ...
    TRC_CHEST_DG_HQ_UPPER_1,
    TRC_CHEST_DG_HQ_UPPER_2,
    TRC_DG_HQ,
...
internal class LocationNames {
    public static Dictionary<Location, string> locationNames = new Dictionary<Location, string> {
        ...
        { Location.EDLA_DROP_MUTANT_MIDDLE_ELEVATOR, "ED (Living Area): Defeat Mutant in Middle Elevator Room" },
        ...
        { Location.EDLA_DROP_MUTANT_FIVE_BELLS, "ED (Living Area): Defeat Mutant in Five Bells Room" },
        ...
        { Location.EDS_DROP_MUTANT_BELOW_HALL, "ED (Sanctum): Defeat Mutant Below Nobility Hall" },
        { Location.EDS_DROP_MUTANT_BELOW_NODE, "ED (Sanctum): Defeat Mutant Below Root Node" },
        ...
        { Location.TRC_DROP_MUTANT_XINGTIAN, "TRC: Defeat Mutant Near Xingtian Sickbay" },
        ...
        { Location.TRC_CHEST_DG_HQ_UPPER_1, "TRC: Dusk Guardian HQ Upper Level 1st Chest" },
        { Location.TRC_CHEST_DG_HQ_UPPER_2, "TRC: Dusk Guardian HQ Upper Level 2nd Chest" },
        { Location.TRC_DG_HQ, "TRC: Examine Dusk Guardian HQ" },
